...
epochs = 30 # maximum epoch (set at 30 for paper)
num_enn = 10
...
def create_model(n, input_shape, num_class, activation, lr):
...
if __name__ == "__main__":
    ...
    X_train,  X_validation, y_train, y_validation = train_test_split(X_train, y_train, test_size=train_test_ratio)
    ...
    for i in range(num_ex):
        ...
        tf.keras.backend.clear_session()
        del model, classification_model

...
import json
from Sausage_initializer import Sausage_weights
from custom_sausage_neuron import SAUSAGE
import warnings
...
def create_model(n, input_shape, num_class, lr,HS_initialization):
    initializer = tf.keras.initializers.GlorotUniform()
    #Create model
    input_1 = Input(shape = (input_shape,))
    hidden_1 = SAUSAGE(n)(input_1)
    ...
    HS_weights = ([HS_initialization.layer_1.q1,HS_initialization.layer_1.q2, HS_initialization.layer_1.r])
    model.layers[1].set_weights(HS_weights)
...
if __name__ == "__main__":
    ...
    for i in range(num_ex):
        ...
        # initialization
        HS_initialization = Sausage_weights(n_components=num_enn)
        HS_initialization.fit(X_train,y_train)
        ...
        model = create_model(n, input_shape, num_class, lr,HS_initialization)
        ...
        # evaluation
        classification_model = load_model(data_directory + data + '_' + backbone_model + '_' + classification_neuron + '_' +  f'epochs_{epochs:02d}.keras', custom_objects={'SAUSAGE': SAUSAGE})
